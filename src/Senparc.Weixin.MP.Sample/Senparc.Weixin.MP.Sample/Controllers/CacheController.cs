...
namespace Senparc.Weixin.MP.Sample.Controllers
{
    ...
    [Serializable]
    internal class User : BaseContainerBag
    {
        private DateTime _dateTime;
        public DateTime DateTime
        {
        ...
        {
            get { return _userId; }
            set { this.SetContainerProperty(ref _userId, value); }
    ...
    [Serializable]
    internal class Phone : BaseContainerBag
    {
        private DateTime _dateTime;
        public DateTime DateTime
        {
        ...
        {
            get { return _tel; }
            set { this.SetContainerProperty(ref _tel, value); }

        }

    }

    internal class UserContainer : BaseContainer<User>
    {
    }
