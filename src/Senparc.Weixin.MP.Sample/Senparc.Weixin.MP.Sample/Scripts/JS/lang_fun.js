...
function langChange(local) {
	...
	var rootPath = getRootPath() + "/Scripts";
	lang_local = local;
	//目前只支持中、英、繁
	if (langIsChinese()) {
		loadScript(rootPath+"/js/lang.js", function() {
			lang = new langChinese();
		});
	} else if (langIsTW()) {
		loadScript(rootPath+"/js/lang_tw.js", function() {
			lang = new langTW();
		});
/*	} else if (langIsTurkey()) {
		...
		loadScript(rootPath+"/js/lang_en.js", function() {
			var langEn = new langEnglish();
			loadScript(rootPath+"/js/lang_ru.js", function() {
		...
		loadScript(rootPath+"/js/lang_en.js", function() {
			var langEn = new langEnglish();
			loadScript(rootPath+"/js/lang_ro.js", function() {
		...
		loadScript(rootPath+"/js/lang_en.js", function() {
			var langEn = new langEnglish();
			loadScript(rootPath+"/js/lang_ar.js", function() {
				lang = new langArabic();
				//lang中没有的从langEn中找到并且追加到lang中
				for (var a in langEn) {
			        if (typeof (lang[a]) == "undefined") {
