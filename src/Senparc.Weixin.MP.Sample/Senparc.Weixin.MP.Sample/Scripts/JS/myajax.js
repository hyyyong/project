...
(function($) {
	...
	$.myajax = {
		 ...
		 */
		jsonPost : function(action, param, formType, callback, dataType) {
			$.myajax.init();
			var data = '';
			if (formType) {
...
//						showErrorMessage(json.result);
		...
		showPagination: function(id) {
			...
			pagination.push("			&nbsp;&nbsp;"+parent.lang.current+" <input id=\"currentPage\" style=\"width:20px;\" name=\"currentPage\" value=\"0\" type=\"text\" onkeydown=\"return onKeyDownDigit(event);\" maxlength=\"4\" /> "+parent.lang.page+"");
